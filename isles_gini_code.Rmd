...
ggplot(filter(isles, position == "F"), aes(x = cf_60, y = ca_60)) + geom_point() +
  geom_text(aes(label=last),hjust=0, vjust=0) + geom_abline(intercept = 0, slope = 1) + 
  labs(x = "Corsi For Per 60", y = "Corsi Against Per 60") + coord_cartesian(xlim = c(35, 80), ylim = c(35, 80)) +
  theme_minimal() 
